...
<template>
    ...
    <div class="bg-base-200 text-base-content/50">
        ...
        />
        <div
            class="relative flex min-h-screen flex-col items-center justify-center selection:bg-primary selection:text-primary-content"
        >
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        <a
                            ...
                            id="docs-card"
                            class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-base-100 p-6 shadow-xl ring-1 ring-base-content/5 transition duration-300 hover:text-base-content focus:outline-none focus-visible:ring-primary md:row-span-3 lg:p-10 lg:pb-10"
                        >
                            <div
                        ...
                        <a
                            ...
                            class="flex items-start gap-4 rounded-lg bg-base-100 p-6 shadow-xl ring-1 ring-base-content/5 transition duration-300 hover:text-base-content focus:outline-none focus-visible:ring-primary lg:pb-10"
                        >
                            <div
                                class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16"
                            >
                        ...
                        <div
                            class="flex items-start gap-4 rounded-lg bg-base-100 p-6 shadow-xl ring-1 ring-base-content/5 lg:pb-10"
                        >
                            <div
                                class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16"
                            >
