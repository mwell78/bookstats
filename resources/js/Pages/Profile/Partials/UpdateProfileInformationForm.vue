            ...
            <div v-if="mustVerifyEmail && user.email_verified_at === null">
                <p class="mt-2 text-sm text-base-content">
                    ...
                    <Link
                        ...
                        method="post"
                        as="button"
                        class="rounded-md text-sm text-base-content/60 underline hover:text-base-content focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
                    >
